this project is cloned from https://github.com/llSourcell/Make_a_neural_network, but i change it to python3, but have no authrity to push it, so copy to my github.
